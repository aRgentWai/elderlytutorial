...
//    options: List<Int>,
    ...
    TopAppBar(
        title = { Text(text = stringResource(R.string.wifi_setting)) },
        navigationIcon = {
...
//        verticalArrangement = Arrangement.SpaceBetween,
        ...
        DataSource.WifiItems.values().forEach { item ->
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp, 8.dp)
                ...
                TextButton(
                    onClick = { onWifiItemClicked(item.title) },
